...
class BegemagParser(BaseParser):
    def __init__(self):
        super().__init__("Бегемаг")
        self.base_url = "https://begemag.ru"
        self.catalog_urls = ["https://begemag.ru/catalog/moloko-i-molochnye-produkty/"]
